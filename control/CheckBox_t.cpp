...
void CheckBox_t::setIsChecked(bool check) { isChecked = check; }

bool CheckBox_t::getIsChecked() { return isChecked; }
...
CheckBox_t::_checkBoxStyle_ CheckBox_t::getStyle() { return style; }
