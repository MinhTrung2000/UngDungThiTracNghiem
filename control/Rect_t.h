...
public:
    ...
    virtual void setCloseFlag(bool flag)
    {
        closeFlag = flag;
    }
    bool getCloseFlag()
    ...
    virtual void setHideFlag(bool flag)
    {
        hideFlag = flag;
    }
    bool getHideFlag()
    ...
    virtual Rect_t *getCurrentFocus()
    {
        return this;
    }
    ...
    virtual Rect_t *getDisplayPanel()
    {
        return NULL;
    }

    virtual void setSelectedMenu(Rect_t *menu) {}
    virtual Rect_t *getSelectedMenu()
    {
        return NULL;
    }

    //=====================
    static void setFocus(Rect_t& rect)
    {
        focusObj = &rect;
    }

    static Rect_t* getFocus()
    {
        return focusObj;
    }
};
