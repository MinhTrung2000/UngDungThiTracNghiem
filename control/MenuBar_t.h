...
public:
  ...
  void setSelectedMenu(Rect_t *menu) { selectedMenu = dynamic_cast<Menu_t *> (menu); }
  Rect_t *getSelectedMenu() { return selectedMenu; }

  void setDisplayPanel(Rect_t *pn);
  Rect_t *getDisplayPanel() { return displayPanel; }
