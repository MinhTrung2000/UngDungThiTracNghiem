...
private:
  ...
  struct FilterPanel : public UIForm {
    ...
    //=====================================================
    FilterPanel(Table_t *tbPtr) : UIForm(BorderFactory::DOUBLE, 55, 12, {80, 30}, "Filter Option"), table(tbPtr) {
      setDefaultColor();
...
public:
	...
	bool empty() { return tableView.empty(); }
  ...
  Vector<Vector<string> > getDataOfTable() { return backUpRows; }
