...
protected:
  ...
  struct ViewPort {
    ...
    virtual bool getCanUpdateBufferFlag() { return false; }
  ...
  struct BufferViewPort : ViewPort {
    ...
    bool getCanUpdateBufferFlag() { return canUpdateBufferFlag; }
...
public:
	...
	bool empty() { return allCheckBoxes.empty(); }
  ...
  int getPortLineNum() { return port->lineNumber; }
