...
: Rect_t(borderType, l, t, {viewWidth + 2, 2}, ""),
  length(length),
  firstPosition(0) {
...
//      deb(firstPosition, currLastPosition, currentPosition.X);
    ...
    case KEY_LEFT: {    // left arrow
      if (currentX == 0 && firstPosition == 0) return;
...
COORD TextField_t::getCurrentPosition() { return currentPosition; }

bool TextField_t::IsCursorVisible() { return true; }
