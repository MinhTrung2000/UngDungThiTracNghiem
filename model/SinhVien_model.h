...
public:
  ...
  ~SinhVien() {
	...
	void setMaSV(const string& newMaSv) { maSV = newMaSv; }
	string getMaSV() { return maSV; }

	void setHo(const string& newHo) { ho = newHo; }
	string getHo() { return ho; }

	void setTen(const string& newTen) { ten = newTen; }
	string getTen() { return ten; }

	void setPhai(const string& newPhai) { phai = newPhai; }
	string getPhai() { return phai; }

	void setMatKhau(const string& newMatKhau) { matKhau = newMatKhau; }
	string getMatKhau() { return matKhau; }

	void setMaLop(const string& newMaLop) { maLop = newMaLop; }
	string getMaLop() { return maLop; }

	void setDSMonDaThi(DSDiemThi_t *ds) { danhSachMonDaThi = ds; }
	DSDiemThi_t *getDSMonDaThi() { return danhSachMonDaThi; }
